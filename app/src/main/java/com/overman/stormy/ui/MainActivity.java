...
import com.overman.stormy.weather.Current;
import com.overman.stormy.weather.Day;
import com.overman.stormy.weather.Forecast;
import com.overman.stormy.weather.Hour;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final double latitude = 38.383424;
        final double longitude = -78.981861;
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = "DELETED FOR SECURITY REASONS"; // Get your own API Key and put it here
